...
class NotifServiceTest {
    ...
    void readNotif_success() {
        ...
        Notif notif = Notif.builder()
                ...
                .title("제목").content("내용").intvId(50L)
                .build();
    ...
    void readNotif_throwsException_whenNotOwner() {
        ...
        Notif notif = Notif.builder()
                ...
                .title("제목").content("내용").noticeId(5L)
                .build();
    ...
    void createAndPush_success() {
        ...
        NotifPublishEvent event = new NotifPublishEvent(
                1L, NotifType.NOTICE, "공지", "내용", 77L
        );
        Notif savedMock = Notif.builder()
                .userId(1L).type(NotifType.NOTICE)
                .title("공지").content("내용").noticeId(77L)
                .build();
